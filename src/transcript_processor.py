...
class TranscriptProcessor:
    def __init__(
        self, model_name="base", language=None, server_url="http://127.0.0.1:8080"
    ):
    ...
    def process_audio_chunk(self, audio_data):
        ...
        try:
            ...
            result = self.client.transcribe_audio_data(
                audio_data, sample_rate=16000, channels=1, language=self.language
            )
    ...
    def process_audio_file(self, file_path):
        ...
        try:
            ...
            result = self.client.transcribe_file(file_path, language=self.language)
    ...
    def change_model(self, model_name):
        ...
        if model_name != self.model_name:
            ...
            print(
                "⚠️  To use a different model, restart the whisper.cpp server with the new model file"
            )
            self.model_name = model_name
